    ...
    stages {
        stage('Stage 1') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/tejparikh/events-app-web-server.git'
        ...
        stage('Stage 2') {
         ...
         stage('Stage 4') {
            steps {
                ...
                sh "gcloud builds submit -t gcr.io/roidtcmar109/web-server:v2.${env.BUILD_ID} ."
            }
        }        
         stage('Stage 5') {
            steps {
                ...
                sh "kubectl set image deployment/demo-ui demo-ui=gcr.io/roidtcmar109/web-server:v2.${env.BUILD_ID} --record"
            }
        }
    }
}
